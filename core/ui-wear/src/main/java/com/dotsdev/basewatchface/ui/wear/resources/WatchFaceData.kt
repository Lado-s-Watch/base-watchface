...
private const val ROUNDED_RECTANGLE_CORNERS_RADIUS = 4.5f
...
private const val GAP_BETWEEN_HAND_AND_CENTER_FRACTION = 0f
...
data class WatchFaceData(
    val activeColorStyle: ColorStyleId = ColorStyleId.RED,
    val ambientColorStyle: ColorStyleId = ColorStyleId.AMBIENT,
